...
EARLY_STOPPING_THRESHOLD = 80 # we stop training and immediately save our model when we reach this average score over the past 100 episodes
INPUT_DIMENSIONS = 4
OUTPUT_DIMENSIONS = 2
...
class ExperienceReplayBuffer():
    ...
    def __init__(self):
        ...
        self.experience_replay = deque(maxlen=MAX_QUEUE_LENGTH)
